...
// Room writes each schema version as JSON here. Commit the files: they are what a future
// migration is written and checked against (table and column names only, no data).
ksp {
